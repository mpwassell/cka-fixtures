...
casper.start('https://w.fixtureslive.com/redirect.aspx?element=login', function(response) {
        this.fill('form#frm', {
            'ctl00$ctl00$ctl00$cphContent$cphContent$cphContent$login1$tbUserName' : '531162',
            'ctl00$ctl00$ctl00$cphContent$cphContent$cphContent$login1$tbPassword' : 'Egerton6'
        }, false);
